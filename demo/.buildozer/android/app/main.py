...
class KivMobDemo(App):
    ...
    APP_ID = "COPY APP ID HERE"
    BANNER_ID = "COPY BANNER ID HERE"
    INTERSTITIAL_ID = "COPY INTERSTITIAL ID HERE"
    TEST_DEVICE_ID = "COPY DEVICE ID HERE"
    
    def build(self):
        self.ads = KivMob("ca-app-pub-9768668056051661~4645944030")
        self.ads.add_test_device("2D6090C9C014AF878DCF51BD01AB8DD9")
        self.ads.new_banner({"unitID":"ca-app-pub-9768668056051661/6122677238"})
        self.ads.new_interstitial("ca-app-pub-9768668056051661/7599410434")
